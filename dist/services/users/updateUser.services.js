...
const updateUserService = (newUSerData, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const oldUserData = yield userRepository.findOneBy({ id: userId });
    const user = userRepository.create(Object.assign(Object.assign({}, oldUserData), newUSerData));
    yield userRepository.save(user);
    const newUser = users_schemas_1.returnUserSchema.parse(user);
    return newUser;
});
